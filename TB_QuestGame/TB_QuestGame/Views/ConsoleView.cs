    ...
    public class ConsoleView
    {
        ...
        public void DisplayStatusBox()
        {
            ...
            if (_viewStatus == ViewStatus.PlayingGame)
            {
                ...
                Console.Write(ConsoleWindowHelper.Center("Traveler Status", ConsoleLayout.StatusBoxWidth - 4));
        ...
        {
            DisplayGamePlayScreen("Traveler Information", Text.TravelerInfo(_gameTraveler), ActionMenu.TravelerMenu, "");
        }
        ...
        public void DisplayLookAround()
        {
            ...
            List<Npc> npcsInCurrentLocation = _gameShip.GetNpcsByLocationId(_gameTraveler.LocationID);
        ...
        public int DisplayGetNextLocation()
        {
            ...
            while (!vaildLocationId)
            {
                ...
                {
                    if (_gameShip.IsAccessableLocation(locationId))
                    {
        ...
        public void DisplayLocationsVisited()
        {
            ...
            DisplayGamePlayScreen("Locations Visited", Text.VisitedLocations(visitedLocations), ActionMenu.TravelerMenu, "");
        }
        ...
        public int DisplayGetGameObjectToLookAt()
        {
            ...
            {
                DisplayGamePlayScreen("Look at a Object", Text.GameObjectsChooseList(gameObjectsInLocation), ActionMenu.ObjectMenu, "");
                ...
                while (!validGamerObjectId)
                {
                    ...
                    //
                    GetInteger($"Enter the Id number of the object you wish to look at: ", 1, 12, out gameObjectId);
        ...
        {
            DisplayGamePlayScreen("Ship Object Information", Text.LookAt(gameObject), ActionMenu.ObjectMenu, "");
        }
        ...
        {
            DisplayGamePlayScreen("List: Non-Player Character", Text.ListAllNpcObjects(_gameShip.Npcs), ActionMenu.AdminMenu,"");
        }
        ...
        public int DisplayGetNpcToTalkTo()
        {
            ...
            //
            List<Npc> npcsInLocation = _gameShip.GetNpcsByLocationId(_gameTraveler.LocationID);
            ...
            if (npcsInLocation.Count > 0)
            {
                ...
                while (!validNpcId)
                {
                    ...
                    // get an integer from the player
                    //
                    GetInteger($"Enter the Id number of the character you wish to speak with: ", 1, 6, out npcId);

                    //
                    // validate integer as a valid NPC id and in current location
                    //
                    if (_gameShip.IsValidNpcByLocationId(npcId, _gameTraveler.LocationID))
                    {
                        Npc npc = _gameShip.GetNpcById(npcId);
                        if (npc is ISpeak)
                        {
                            validNpcId = true;
                        }
