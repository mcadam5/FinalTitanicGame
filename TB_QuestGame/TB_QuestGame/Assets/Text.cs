...
namespace TB_QuestGame
{
    ...
    public static class Text
    {
        ...
        public static string CurrrentLocationInfo()
        {
            ...
            " \n" +
            "Your fist job is to gain access to a meal card to open up the kitchen. " +
            " \n" +
            " \n" +
        ...
        {
            string messageBoxText =
                "Before you begin your journey we much gather your base data.\n" +
                " \n" +
        ...
        {
            string messageBoxText =
                $"{gameTraveler.Name}, Were would you like to travel next? \n" +
                "\n" +
        ...
        public static string GameObjectsChooseList(IEnumerable<GameObject> gameObjects)
        {
            ...
            return messageBoxText + gameObjectRows;
        }
        ...
        public static List<string> StatusBox(Traveler traveler, Ship ship)
        {
            ...
            statusBoxText.Add($"Passenger Experience: {traveler.Experiencepoints}\n");
